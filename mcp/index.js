 ...
 * 72 tasarım stilini (canlı örnek + AI promptu) Claude Code, Cursor gibi
...
const TOOLS = [
  {
    name: "stil_listele",
    description:
      "Katalogdaki 72 tasarım stilini listeler (id, isim, ekol, bölüm, kısa açıklama). " +
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: { id: { type: "number", description: "Stil no (1-72)" } },
      required: ["id"],
    },
  },
];
